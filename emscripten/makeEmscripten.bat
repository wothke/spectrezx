...
rem
set "OPT2=  -Wcast-align -fno-strict-aliasing -s VERBOSE=0 -s SAFE_HEAP=0 -s DISABLE_EXCEPTION_CATCHING=0 -DNO_DEBUG_LOGS  -DBLOODY_HACK -DBOOST_NO_RTTI -DBOOST_SYSTEM_NO_DEPRECATED -DNO_L10N -DBOOST_ERROR_CODE_HEADER_ONLY -Wno-pointer-sign -I. -I.. -I../include -I./include -I../3rdparty/zlib/ -I../3rdparty/z80ex/ -I../3rdparty/z80ex/include -I../3rdparty/curl/ -I../boost/ -I../src/  -Os  -O3 "
